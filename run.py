...
categories = [
        {'search_word':'gtx970', 'price_boundary':[600, 800], 'keywords':['冰龙','超级冰龙','红龙','名人堂','龙骑士','至尊','烈焰'], 'stopwords':['回收','收','高价','网吧']},
        {'search_word':'酷冷至尊gx450', 'price_boundary':[100, 300], 'keywords':['酷冷','450'], 'stopwords':['回收','收','高价']},
        {'search_word':'amd专用条', 'price_boundary':[50, 100], 'keywords':['amd','8100','专用'], 'stopwords':['回收','收','高价']},
